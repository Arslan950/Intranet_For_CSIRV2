...
const Dashboard = ({ token, role, username ,open ,setopen})  => {
  ...
  return (
    // <SidebarLayout setopen={setopen} open={open}>
      ...
      {/* <div className="w-full bg-gray-400 h-1 my-2"></div> */}  
      <NewWebMail  Classes={`lg:col-span-1  sm:col-span-2 col-span-4   max-h-98 min-h-58`}/>
      {/* <GoveLinks  Classes={`lg:col-span-1  sm:col-span-2 col-span-4  border border-gray-300 max-h-58`}/> */}
    </div>
      <Footer />
      {/* <LoaderModal  loading={loading} message="Fetching data..." /> */}
